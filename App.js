const apiKey = "a53cc5da24eea51e42789024d0fc5e32";
          ...
          <h2>${movie.title}</h2>
            <div class="popup-details">
                ...
                <div class="popup-info">
                    ...
                    <button onclick="openCheckoutPage('${
                      movie.title
                    }', ${getRandomPrice()})">Book Tickets</button>
                </div>
            </div>
        `;
  ...
  checkoutContent.innerHTML = `
          <div class="summary-section">
              ...
              <div class="summary-item">
                  ...
                  <span class="summary-value" id="convenienceFee">${
                    price * 0.02
                  }</span>
              </div>
              <div class="summary-item">
